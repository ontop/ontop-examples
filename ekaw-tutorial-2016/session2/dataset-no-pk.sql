...
CREATE INDEX ON "uni1"."student" ("s_id");
...
CREATE INDEX ON "uni1"."academic" ("a_id");
...
CREATE INDEX ON "uni1"."course" ("c_id");
...
CREATE INDEX ON "uni2"."person" ("pid");
...
CREATE INDEX ON "uni2"."course" ("cid");
