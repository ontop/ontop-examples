...
FROM (
SELECT 
   5 AS "wellboreQuestType", NULL AS "wellboreLang", CAST(QVIEW7."wlbTotalCoreLength" AS VARCHAR(500)) AS "wellbore", 
   ...
   5 AS "yearQuestType", NULL AS "yearLang", CAST(QVIEW7."wlbTotalCoreLength" AS VARCHAR(500)) AS "year"
 FROM 
...
"npd_no_spatial_10"."wellbore_npdid_overview" QVIEW6,
