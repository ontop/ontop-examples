CREATE TABLE apaAreaGross (
    ...
    apaAreaGross_id numeric(19)  NOT NULL,
...
CREATE TABLE apaAreaNet (
    ...
    apaAreaNet_id numeric(19)  NOT NULL,
...
CREATE TABLE company (
    cmpLongName varchar(200) NOT NULL,
    cmpOrgNumericBrReg varchar(100) DEFAULT NULL,
...
CREATE TABLE licence_phase_hst (
    prlName varchar(50) NOT NULL,
    prlDatePhaseValidFrom date ,
    prlDatePhaseValidTo date ,
...
CREATE TABLE prlArea (
    ...
    prlArea_id numeric(19)  NOT NULL,
...
CREATE TABLE seaArea (
    ...
    seaArea_id numeric(19)  NOT NULL,
...
CREATE TABLE seaMultiline (
    ...
    seaSensorNumerics varchar(40) NOT NULL,
...
CREATE TABLE s_a_c_inc_turnarea (
    seaSurveyName varchar(100) NOT NULL,
    seaNpdidSurvey integer NOT NULL,
    seaPolygonPointNumeric integer NOT NULL,
    ...
    dateSyncNPD date NOT NULL,
    PRIMARY KEY (seaSurveyName,seaPolygonPointNumeric)
);
...
CREATE TABLE seis_acquisition_progress (
    ...
    seaNpdidSurvey integer NOT NULL,
    seis_acquisition_progress_id numeric(19)  NOT NULL,
...
CREATE TABLE wellbore_casing_and_lot (
    ...
    dateSyncNPD date NOT NULL,
    wellbore_casing_and_lot_id numeric(19)  NOT NULL,
...
CREATE TABLE wellbore_core (
    wlbName varchar(60) NOT NULL,
    wlbCoreNumeric integer NOT NULL,
    ...
    wlbNumericOfCores integer NOT NULL,
    wlbCoreSampleAvailable varchar(3) NOT NULL,
    wlbNpdidWellbore integer NOT NULL,
    wlbCoreDateUpdated date DEFAULT NULL,
    dateSyncNPD date NOT NULL,
    wellbore_core_id numeric(19)  NOT NULL,
    PRIMARY KEY (wellbore_core_id,wlbNpdidWellbore,wlbCoreNumeric),
...
CREATE TABLE wellbore_core_photo (
    ...
    wellbore_core_photo_id numeric(19)  NOT NULL,
    PRIMARY KEY (wellbore_core_photo_id,wlbNpdidWellbore,wlbCoreNumeric,wlbCorePhotoTitle),
...
CREATE TABLE wellbore_development_all (
    ...
    wlbDrillingOperator varchar(200) NOT NULL,
...
CREATE TABLE wellbore_document (
    ...
    dateSyncNPD date NOT NULL,
    wellbore_document_id numeric(19)  NOT NULL,
...
CREATE TABLE wellbore_dst (
    wlbName varchar(60) NOT NULL,
    wlbDstTestNumeric decimal(13,6) NOT NULL,
    ...
    dateSyncNPD date NOT NULL,
    PRIMARY KEY (wlbNpdidWellbore,wlbDstTestNumeric)
);
...
CREATE TABLE wellbore_mud (
    ...
    dateSyncNPD date NOT NULL,
    wellbore_mud_id numeric(19)  NOT NULL,
...
CREATE TABLE wellbore_oil_sample (
    ...
    wlbOilSampleTestNumeric varchar(15) DEFAULT NULL,
    ...
    dateSyncNPD date NOT NULL,
    wellbore_oil_sample_id numeric(19)  NOT NULL,
