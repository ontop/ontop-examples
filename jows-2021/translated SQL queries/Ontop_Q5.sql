...
WHERE (ST_WITHIN(v1."geom",'POLYGON((11 46.45, 11.6 46.45, 11.6 46.64, 11 46.64, 11 46.45))') AND v1."geom" IS NOT NULL AND v1."id" = v2."node_id" AND v1."id" = v5."node_id1m3" AND 'http://www.w3.org/1999/02/22-rdf-syntax-ns#type' = v2."property" AND 'http://linkedgeodata.org/ontology/Bank' = v2."object")
UNION ALL 
...
WHERE (ST_WITHIN(v7."geom",'POLYGON((11 46.45, 11.6 46.45, 11.6 46.64, 11 46.64, 11 46.45))') AND v7."geom" IS NOT NULL AND v7."id" = v8."node_id" AND v7."id" = v11."node_id1m9" AND 'http://www.w3.org/1999/02/22-rdf-syntax-ns#type' = v8."property" AND 'http://linkedgeodata.org/ontology/Bank' = v8."object")
) v13
) v15
