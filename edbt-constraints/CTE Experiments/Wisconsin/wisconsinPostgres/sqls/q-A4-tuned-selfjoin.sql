...
SELECT 
   ...
   4 AS "zQuestType", NULL AS "zLang", CAST(QVIEW3.yx AS VARCHAR(10485760)) AS "z"
 FROM 
Tab1 QVIEW1,
SnRCTE QVIEW2,
SnRCTE QVIEW3
...
QVIEW2.yx IS NOT NULL AND
(QVIEW1."unique2tab2" = QVIEW3.yyy) AND
QVIEW3.yx IS NOT NULL
UNION ALL
SELECT 
...
QVIEW2.yx IS NOT NULL AND
(QVIEW1."unique2tab3" = QVIEW3.yyy) AND
QVIEW3.yx IS NOT NULL
UNION ALL
SELECT 
...
QVIEW2.yx IS NOT NULL AND
(QVIEW1."unique2tab4" = QVIEW3.yyy) AND
QVIEW3.yx IS NOT NULL
