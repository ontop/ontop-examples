       ...
       (SELECT
        ...
        FROM review v1 LEFT JOIN review v2
        ON v1.product = v2.product AND (v2.language = 'zh' OR v2.language = 'en')
       ...
       (SELECT
          ...
          v1.text AS review_text
        FROM review v1 LEFT JOIN review v2
            ON v1.product = v2.product AND (v2.language = 'zh' OR v2.language = 'en' OR v2.language = 'de')
        WHERE v1.language = 'fr' AND v1.product < 1000 AND v2.product IS NULL);
