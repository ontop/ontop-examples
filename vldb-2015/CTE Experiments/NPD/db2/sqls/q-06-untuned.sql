...
SELECT 
   ...
   5 AS "yearQuestType", NULL AS "yearLang", CAST(QVIEW8."lsuCoreLenght" AS VARCHAR(500)) AS "year"
 FROM 
...
"npd_no_spatial_10"."strat_litho_wellbore_core" QVIEW6,
"npd_no_spatial_10"."wellbore_npdid_overview" QVIEW7,
"npd_no_spatial_10"."strat_litho_wellbore_core" QVIEW8
WHERE 
...
QVIEW6."lsuNpdidLithoStrat" IS NOT NULL AND
(QVIEW6."lsuNpdidLithoStrat" = QVIEW8."lsuNpdidLithoStrat") AND
(QVIEW1."wlbNpdidWellbore" = QVIEW8."wlbNpdidWellbore") AND
QVIEW8."lsuCoreLenght" IS NOT NULL AND
((QVIEW8."lsuCoreLenght" > 50) AND (QVIEW2."wlbCompletionYear" >= 2008))
UNION
SELECT 
