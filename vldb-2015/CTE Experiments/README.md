This folder contains the needed material in order to replicate the CTE-based tuning experiments for the Wisconsin and NPD settings described in the paper for [VLDB 2015](vldb-2015).
