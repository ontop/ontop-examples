...
qview2."stringu2" IS NOT NULL AND
qview2."stringu1" IS NOT NULL
) f_2, (SELECT qview1."unique2" AS t0v0,  qview2."evenonepercent" AS t4v0,  qview2."string4" AS t4v1,  qview2."stringu1"
AS t4v2 FROM
"public"."t17_1m" qview1,
...
UNION
SELECT qview1."unique2" AS t0v0,  qview2."evenonepercent" AS t4v0,  qview2."string4" AS t4v1,  qview2."stringu1"
AS t4v2 FROM
"public"."t13_1m" qview1,
"public"."t20_1m" qview2
WHERE
