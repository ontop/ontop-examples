...
CREATE INDEX LOCATIONOFEW_IDX_FROM ON LOCATIONOFEW (dFrom);
CREATE INDEX LOCATIONOFEW_IDX_TO ON LOCATIONOFEW (dTo);
CREATE INDEX LOCATIONOFEW_IDX_FROM_TO ON LOCATIONOFEW (dFrom,dTo);
CREATE INDEX LOCATIONOFWW_IDX_FROM ON LOCATIONOFWW (dFrom);
CREATE INDEX LOCATIONOFWW_IDX_TO ON LOCATIONOFWW (dTo);
...
CREATE INDEX LOCATIONOFNW_IDX_FROM ON LOCATIONOFNW (dFrom);
CREATE INDEX LOCATIONOFNW_IDX_TO ON LOCATIONOFNW (dTo);
CREATE INDEX LOCATIONOFNW_IDX_FROM_TO ON LOCATIONOFNW (dFrom,dTo);
CREATE INDEX LOCATIONOFSW_IDX_FROM ON LOCATIONOFSW (dFrom);
CREATE INDEX LOCATIONOFSW_IDX_TO ON LOCATIONOFSW (dTo);
...
CREATE INDEX F1_IDX_FROM ON F1 (x_from_1);
CREATE INDEX F1_IDX_TO ON F1 (x_to_1);
CREATE INDEX F1_IDX_FROM_TO ON F1 (x_from_1,x_to_1);
CREATE INDEX F2_IDX_FROM ON F2 (x_from_2);
CREATE INDEX F2_IDX_TO ON F2 (x_to_2);
